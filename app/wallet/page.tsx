      ...
      <div className="min-h-screen bg-[#F8FAFC] flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center px-4">
            <WalletIcon size={56} className="text-gray-300 mx-auto mb-4" />
            <h3 className="text-xl font-bold text-gray-600 mb-2">Portefeuille indisponible</h3>
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        <div className="flex items-center gap-4 mb-8">
          <Link href="/" className="h-10 w-10 flex items-center justify-center rounded-full bg-white shadow-sm hover:text-primary transition-colors">
            <ArrowLeft size={18} />
          </Link>
          <h1 className="text-3xl font-black text-gray-900">Mon Portefeuille</h1>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {/* Main Balance Card */}
          <div className="md:col-span-2 bg-gradient-to-br from-primary to-green-600 p-8 rounded-[2.5rem] shadow-xl text-white relative overflow-hidden group">
          ...
          <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-gray-100 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between p-4 mb-4 bg-green-50 rounded-2xl">
                <div className="flex items-center gap-2">
                  <CheckCircle size={14} className="text-green-600" />
                  <span className="text-xs font-bold text-green-700">Disponible</span>
                </div>
                <span className="font-black text-green-700">{formatPrice(availableBalance)}</span>
              </div>
              <div className="flex items-center justify-between p-4 bg-orange-50 rounded-2xl">
                <div className="flex items-center gap-2">
                  <Lock size={14} className="text-orange-600" />
                  <span className="text-xs font-bold text-orange-700">Bloqué</span>
                </div>
                <span className="font-black text-orange-700">{formatPrice(wallet?.locked_amount || 0)}</span>
              </div>
            </div>
          ...
          <div className="divide-y divide-gray-50">
            {transactions.length === 0 ? (
              <div className="p-12 text-center text-gray-500">
                <ClipboardList size={44} className="text-gray-200 mx-auto mb-2" />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden">
            <div className="p-8 text-center">
              ...
              <h3 className="text-2xl font-black mb-4 text-gray-900">Rechargement bientôt disponible</h3>
